...
///<reference path="PeacefulForest_Tree.ts"/>
///<reference path="../../main/classes/Pos.ts"/>
///<reference path="../../main/quest-entities/Wall.ts"/>
///<reference path="../../main/classes/QuestEntityHealthBar.ts"/>
...
class PeacefulForest_Quest extends Quest{
    ...
    constructor(game: Game){
        ...
        this.addPlayerCollisionBoxes(true, false, true, true); // this means that the player will only be able to get out of the quests on the right side
        ...
        this.getGame().getPlayer().setGlobalPosition(new Pos(0, 9)); // the player will begin the quests at the x position of 0 and the y position of 9
        this.configPlayerOrClone(this.getGame().getPlayer()); // configure the player (see below in the public methods part)
        this.addEntity(this.getGame().getPlayer()); // finally add the player to the quests
