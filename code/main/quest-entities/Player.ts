...
class Player extends QuestEntity{
    ...
    public getQuestEntityWeapon(quest: Quest = null): QuestEntityWeapon{
        ...
        // If a weapon is equipped, we use the quests entity weapon it provides us
    ...
    public loadCandyBoxCharacter(quest: Quest, firstTime: boolean = true): void{
        ...
        // Load stuff common to all characters if it's the first time we load the character in this quests
