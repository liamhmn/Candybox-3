                    ...
                    if(words.length > 1){
                        ...
                        // Else, no third word, we do something different depending on the second word
                            ...
                            switch(words[1]){
                                ...
                                break;
                                case "add":
                                    this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "The add command allows you to add a given quantity of a given game_resources. Usage : \"add quantity game_resources\"."));
                                break;
                                case "quantity":
                                ...
                                break;
                                case "game_resources":
                                    this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "List of available game_resources : candies, lollipops, chocolatebars, painsauchocolat."));
                                break;
                                case "bug":
                                ...
                                break;
                                case "type":
                                    this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "The bug type is the kind of bug you want to configure. Allowed types are \"graphical\", \"quests\" and \"ultimate\". Use \"help graphical\", \"help quests\" or \"help ultimate\" for more information."));
                                break;
                                case "graphical":
                    ...
                    if(words.length > 1){
                        ...
                        if(words.length > 2){
                            ...
                            // Else, no fourth word
                                ...
                                // Else, if the third word isn't a valid game_resources
                                else if(words[2] != "candies" && words[2] != "lollipops" && words[2] != "chocolatebars" && words[2] != "painsauchocolat")
                                    this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "The game_resources is invalid. See \"help game_resources\" for more informations."));
                                // Else, everything's okay
                                else{
                                    // Execute the command, depending on the game_resources given
                                    switch(words[2]){
                                        case "candies":
                        ...
                        // Else, no third word
                            ...
                            this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "You must give a game_resources. See \"help add\" for more informations."));
                        }
                    }
                    // Else, no second word
                    else{
