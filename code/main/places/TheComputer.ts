                    ...
                    if(words.length > 1){
                        ...
                        // Else, no third word, we do something different depending on the second word
                            ...
                            switch(words[1]){
                                ...
                                break;
                                case "add":
                                    this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "The add command allows you to add a given quantity of a given resources. Usage : \"add quantity resources\"."));
                                break;
                                case "quantity":
                    ...
                    if(words.length > 1){
                        ...
                        if(words.length > 2){
                            ...
                            // Else, no fourth word
                                ...
                                // Else, if the third word isn't a valid resources
                                else if(words[2] != "candies" && words[2] != "lollipops" && words[2] != "chocolatebars" && words[2] != "painsauchocolat")
                                    this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "The resources is invalid. See \"help resources\" for more informations."));
                                // Else, everything's okay
                                else{
                                    // Execute the command, depending on the resources given
                                    switch(words[2]){
                                        case "candies":
                        ...
                        // Else, no third word
                            ...
                            this.addLine(new TheComputerLine(TheComputerLineType.TEXT, "You must give a resources. See \"help add\" for more informations."));
                        }
                    }
                    // Else, no second word
                    else{
