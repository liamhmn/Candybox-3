...
class TheSea extends Quest{
    ...
    public castPlayerTeleport(): void{
        // We teleport, be we stay on the left side of the quests
    ...
    private generateShellPowder(x1: number, x2: number): void{
        // If we don't already have shell powder and no shell powder have been generated in this quests so far and the distance is at least 500
    ...
    private generateSponge(x1: number, x2: number): void{
        // If we don't already have a sponge and no sponge have been generated in this quests so far and the distance is at least 793
