...
class Quest extends Place{
    ...
    private realQuestSize: Pos; // The real quests size
    ...
    private sizeToAddToTheRealQuestSize: Pos; // For the quests log, for example
    private globalDrawingOffset: Pos = new Pos(0, 0); // Global offset applied to all entities (very useful when dealing with a scrolling quests like the hole for example)
