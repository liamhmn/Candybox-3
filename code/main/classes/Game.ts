...
///<reference path="../game_resources/Lollipops.ts"/>
///<reference path="../game_resources/ChocolateBars.ts"/>
///<reference path="../game_resources/PainsAuChocolat.ts"/>
///<reference path="../game_resources/CandiesEaten.ts"/>
///<reference path="../game_resources/CandiesThrown.ts"/>
///<reference path="../items/GridItem.ts"/>
///<reference path="../items/EqItem.ts"/>
...
///<reference path="../places/Village.ts"/>
///<reference path="../places/CandyBox.ts"/>
///<reference path="../places/Castle.ts"/>
///<reference path="../quests/CastleEntrance.ts"/>
///<reference path="../places/Cauldron.ts"/>
///<reference path="../places/Cfg.ts"/>
///<reference path="../places/InsideFortress.ts"/>
///<reference path="../places/InsideYourBox.ts"/>
///<reference path="../places/Inventory.ts"/>
///<reference path="../places/Lighthouse.ts"/>
///<reference path="../places/LollipopFarm.ts"/>
///<reference path="../places/MainMap.ts"/>
///<reference path="../places/Save.ts"/>
///<reference path="../places/SorceressHut.ts"/>
///<reference path="../places/TheArena.ts"/>
///<reference path="../places/TheCave.ts"/>
///<reference path="../places/TheComputer.ts"/>
///<reference path="../quests/Yourself.ts"/>
///<reference path="../items/WoodenSword.ts"/>
///<reference path="../items/IronAxe.ts"/>
///<reference path="../items/PolishedSilverSword.ts"/>
///<reference path="../items/TrollBludgeon.ts"/>
///<reference path="../items/MonkeyWizardStaff.ts"/>
///<reference path="../items/EnchantedMonkeyWizardStaff.ts"/>
///<reference path="../items/TribalSpear.ts"/>
///<reference path="../items/SummoningTribalSpear.ts"/>
///<reference path="../items/GiantSpoon.ts"/>
///<reference path="../items/Scythe.ts"/>
///<reference path="../items/GiantSpoonOfDoom.ts"/>
///<reference path="../items/OctopusKingCrown.ts"/>
///<reference path="../items/OctopusKingCrownWithJaspers.ts"/>
///<reference path="../items/OctopusKingCrownWithObsidian.ts"/>
///<reference path="../items/MerchantHat.ts"/>
///<reference path="../items/SorceressHat.ts"/>
///<reference path="../items/LightweightBodyArmour.ts"/>
///<reference path="../items/KnightBodyArmour.ts"/>
///<reference path="../items/EnchantedKnightBodyArmour.ts"/>
///<reference path="../items/LeatherGloves.ts"/>
///<reference path="../items/RedEnchantedGloves.ts"/>
///<reference path="../items/PinkEnchantedGloves.ts"/>
///<reference path="../items/LeatherBoots.ts"/>
///<reference path="../items/RocketBoots.ts"/>
///<reference path="../items/BootsOfIntrospection.ts"/>
///<reference path="../items/Feather.ts"/>
///<reference path="Pos.ts"/>
///<reference path="../items/UnicornHorn.ts"/>
///<reference path="../items/XinopherydonClaw.ts"/>
...
class Game{    
    ...
    // Is the quests slowed down ?
    private questSlowedDown: boolean = false;
    
    // A special number used to slow down the quests callback precisely
